    ...
    <div className={styles.main}>
      <ScrollContext.Provider value={{ scrollingElement }}>
        <div className={styles["scrolling-view"]} ref={scrollingElRef}>
          <StickyView className={styles["view-height-1"]}>
            {(proportion) => (
              <div className={styles["full-sticky-content sticky-content-1"]}>
                ...
                >
                  <h1>{proportion}</h1>
                  <p>
                    This section has code that takes the number above and does
                    the following:
                  </p>
          ...
          <StickyView className={styles["view-height-2"]}>
            {(proportion) => (
              <div className={styles["full-sticky-content sticky-content-2"]}>
                ...
                >
                  ...
                  <h6>The text:</h6>
                  <p>
                    Slides in when proportion is between 0 and 1, doing so even
                    if you stop scrolling.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    continuing to make display dependent on scroll position!
                    (CSS is pretty cool!)
                  </p>
                </div>
                <div
          ...
          <StickyView className={styles["view-height-3"]}>
            {(proportion) => (
